...
class DoctorController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'txtpaterno' => 'required|string|max:255',
            'txtmaterno' => 'required|string|max:255',
            'txtci' => 'required|string|max:255',
            'txtcelular' => 'required|string|max:255',
            'txtespe' => 'required|string|max:255',
        ...
        Doctor::create([
            ...
            'apellido_paterno' => $request->txtpaterno,
            'apellido_materno' => $request->txtmaterno,
            'cedula_identidad' => $request->txtci,
            'telefono' => $request->txtcelular,
