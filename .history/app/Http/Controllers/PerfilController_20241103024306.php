...
public function update(Request $request, $id)
{
    ...
    // Validar los campos incluyendo la contraseña actual
    $request->validate([
    ...
    if (!Hash::check($request->current_password, $user->password)) {
        return redirect()->route('profile.index')->with('error', 'La contraseña actual no es correcta.');
    }
    ...
    $user->save(); // Esto debería funcionar ahora sin errores
    return redirect()->back();
...
//     // Validar los campos, incluyendo la imagen opcional
//     $request->validate([
//         'name' => 'required|string|max:255',
//         'email' => 'required|email|max:255|unique:users,email,' . $user->id,
//         'password' => 'nullable|min:8|confirmed',
