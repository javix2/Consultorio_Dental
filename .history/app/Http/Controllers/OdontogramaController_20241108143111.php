...
class OdontogramaController extends Controller
{
    ...
    public function registrar(Request $request) 
    {
        ...
        //     'estado' => 'required',
        //     'ci' => 'required|exists:pacientes,carnet', // Valida que el carnet exista en la tabla de pacientes
        // ]);

        // Encuentra el paciente por el carnet
        ...
        $odontograma -> num_diente = $request->input('num_diente');
        $odontograma -> lado_diente = $request->input('lado_diente');
        $odontograma -> estado = $request->input('estado');
        $odontograma -> paciente_id = $request->input('paciente_id');
        $odontograma->save();
