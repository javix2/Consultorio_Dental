...
class OdontogramaController extends Controller
{
    ...
    public function registrar(Request $request) 
    {
        $validatedData = $request->validate([
            ...
            'estado' => 'required',
            'carnet' => 'required|exists:pacientes,carnet', // Valida que el carnet exista en la tabla de pacientes
        ]);
        ...
        $odontograma = new Odontograma([
            'num_diente' => $validatedData['num_diente'],
            'lado_diente' => $validatedData['lado_diente'],
            'estado' => $validatedData['estado'],
            'paciente_id' => $paciente->id, // Asociar el odontograma al paciente
        ]);
        $odontograma->save();
