    ...
    public function update(Request $request, $id)
{
    ...
    if ($event) {
        ...
        // Asumiendo que tienes una lógica para calcular la hora final basada en el tiempo
        $hora_final = // lógica para calcular la hora final;

        return response()->json(['message' => 'Evento actualizado exitosamente.', 'hora_final' => $hora_final], 200);
    } else {
        return response()->json(['message' => 'Evento no encontrado.'], 404);
    }
}
