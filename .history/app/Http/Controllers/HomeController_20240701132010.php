...
class HomeController extends Controller
{
         ...
         foreach ($citas as $cita) {
             $events[] = [
                ...
                'extendedProps'=> [
                    ...
                    // 'tiempo' => $cita->hora_final - $cita->hora_inicial,
                    ...
                    // Devuelve el resultado en un array o directamente como una variable
                    $resultado = ['tiempo' => $minutos],
                    // o
                    'tiempo' => $minutos,
    ...
    public function show2($id)
    {
        ...
        $event = [
            ...
            'end' => $cita->fecha . " " . $cita->hora_final,
            'tratamiento' => $cita->tratamiento->nombre,
            'doctor' => $cita->doctor->nombre . " " . $cita->doctor->paterno,
            'estado' => $cita->estado,
        ];
