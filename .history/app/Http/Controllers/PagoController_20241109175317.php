...
class PagoController extends Controller
{
    ...
    public function mostrarPagos($historialTratamientoId)
    {
        // Obtener el historial del tratamiento del paciente
        $histo = HistorialTratam::findOrFail($historialTratamientoId);
        ...
        return view('pagos.registrar', compact('histo', 'pagosRealizados'));
    }
