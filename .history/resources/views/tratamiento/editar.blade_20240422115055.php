            ...
            <div class="modal-body">
                <form class="" action="{{ route("tratamiento.update", $trat->id) }}" method="POST">
                    ...
                    <div class="container py-3 ">
                        ...
                        {{--  <div class="form-group row">
                            <label for="" class="col-sm-4 col-form-label  text-right">Encargado</label>
                            <div class="col-sm-6">
                                <select id="inputState" class="form-select fst-italic" name="doctor_id" value="{{$item->doctor_id}}">
                                <option selected>seleccione</option>
                            
                                @foreach($doctors as $doc)
                                    <option value="{{ $doc->id }}">{{ $doc->nombre }} {{ $doc->paterno }} {{ $doc->materno }}</option>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i
                                class="fa-regular fa-circle-xmark"></i> Cancelar</button>
                    </div>
                </form>
            </div>
        </div>
