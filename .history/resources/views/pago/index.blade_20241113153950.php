            ...
            @foreach($histo_tratams as $histo)
                <tr>
                    ...
                    <td>
                        ...
                        {{--  <a href="{{ route('pago.reporteboleta',$histo->id) }}" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modalVer{{$histo->id}}"><i class="fa-solid fa-print"></i></a>  --}}
