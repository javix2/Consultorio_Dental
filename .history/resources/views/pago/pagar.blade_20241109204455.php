                ...
                <div class="modal-body">
                    ...
                    @if($histo->pagos->isNotEmpty())
                        <div style="max-height: 300px; overflow-y: auto;">
                            ...
                            <table class="table table-bordered table-sm mt-3 w-75 mx-auto">
                                <thead>
                                    <tr>
                                        <th>Fecha de Pago</th>
                                        <th>Monto</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex justify-content-around">
                                                    <a href="{{ route('pagos.editar', $pago->id) }}" class="btn btn-warning btn-sm">Editar</a>
                                                    <form action="{{ route('pagos.eliminar', $pago->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar este pago?');">
                                                        @csrf
                                                        @method('DELETE')
