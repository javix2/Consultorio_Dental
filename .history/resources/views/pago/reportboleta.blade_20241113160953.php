...
<html lang="es">
  ...
  <body>
    ...
    <div class="modal-body px-2">
        ...
        <p class="mb-1"><strong>Nombre:</strong> {{ $pago->paciente->nombre }} {{ $pago->paciente->paterno }} {{ $pago->paciente->materno }}</p>
        <p class="mb-1"><strong>Tratamiento:</strong> {{ $pago->tratamiento->nombre }}</p>
                ...
                <ul class="list-group list-group-flush" style="max-height: 150px; overflow-y: auto;">
                    @foreach($pago->pagos as $pago)
                        <li class="list-group-item d-flex justify-content-between align-items-center p-1">
                            <div>
                                <strong>Fecha:</strong> {{ $pago->created_at->format('d/m/Y H:i') }} {{ $pago->monto }} "BOB"<br>
                                <strong>Monto:</strong> 
                            </div>
                            <div class="d-flex">
