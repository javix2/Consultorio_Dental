    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('pagos.registrarPago', $tratamientoPaciente->id) }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="monto">Monto a Pagar:</label>
                        <input type="number" name="monto" class="form-control" min="1" max="{{ $tratamientoPaciente->saldo }}" required>
                    </div>
