            ...
            @foreach($histo_tratams as $histo)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalPagar{{$histo->id}}"><i class="fa-solid fa-money-bills" style="color: #2bdda8;"></i>Pagar</a>
