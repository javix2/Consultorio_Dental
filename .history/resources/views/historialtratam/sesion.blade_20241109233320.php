    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('sesion.registroSesion',$histo->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="container py-3 px-7">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" name="numero_sesion" id="numero_sesion" class="form-control" value="{{$histo->sesion + 1}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
