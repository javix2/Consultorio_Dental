  ...
  <table class="table table-striped table-hover ">
    ...
    <tbody class="table-group-divider">
      ...
      <tr>
        ...
        <td class="
            @if ($histo->sesions->first()->estado === 'en curso') badge badge-warning
            @elseif ($histo->sesions->first()->estado === 'terminado') text-success
            @elseif ($histo->sesions->first()->estado === 'pendiente') text-danger
            @else text-secondary
            @endif">
            {{ $histo->sesions->first()->estado ?? 'No hay sesiones' }}
        </td>
