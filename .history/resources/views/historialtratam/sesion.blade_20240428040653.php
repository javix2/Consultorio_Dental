                    ...
                    <div class="container py-3 px-7">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                {{--  <input type="text" name="paciente_id" id="paciente_id" class="form-control" value="{{$historial->paciente->nombre}} {{$historial->paciente->paterno}} {{$historial->paciente->materno}}" readonly>  --}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" name="numero_sesion" id="numero_sesion" class="form-control" value="{{$histo->numero_sesion}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
