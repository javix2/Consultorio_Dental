    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">  
          ...
          <label for="inputPassword" class="col-sm-2 col-form-label text-right">contraseña</label>
          <div class="col-sm-3">
            <input type="text" class="form-control" id="inputAddress" name="celular" value="{{$doc->celular}}">
          </div>
        </div>
        <div class="form-group row">  
          ...
          <label for="inputPassword" class="col-sm-2 col-form-label text-right">Confirmar contraseña</label>
          <div class="col-sm-3">
            <input type="text" class="form-control" id="inputAddress" name="celular" value="{{$doc->celular}}">
          </div>
        </div>
