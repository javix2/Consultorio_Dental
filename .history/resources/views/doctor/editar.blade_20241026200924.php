          ...
          @method('PATCH')
            <div class="card text-bg-light">
              ...
              <div class="form-group row">  
                ...
                <div class="col-sm-5">
                  <input type="password" class="form-control"  name="current_password" value="$doc->user->name" required>
                </div>
              </div>
              <div class="form-group row">  
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    @if(session('success'))
      // Abre el modal si hay un mensaje de éxito en la sesión
      var myModal = new bootstrap.Modal(document.getElementById('modalEditar{{$doc->id}}'));
      myModal.show();
    @endif
  });
</script>