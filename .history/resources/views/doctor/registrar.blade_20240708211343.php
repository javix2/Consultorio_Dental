        ...
        <form action="" method="post">
          ...
          <div class="container py-3 px-7">
            ...
            <div class="form-group row">
              <label for="inputPassword" class="col-sm-3 col-form-label  ">Correo Electronico</label>
              <div class=" col-sm-8">
                <input class="form-control" id="" name="txtdireccion"></input>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              <label for="inputPassword" class="col-sm-3 col-form-label  ">Confirmar Contraseña</label>
              <div class=" col-sm-8">
                <input class="form-control" type="password" id="" name="txtdireccion"></input>
              </div>
            </div>
