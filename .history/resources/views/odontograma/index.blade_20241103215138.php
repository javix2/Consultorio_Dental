            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mb-3">
                            <label for="searchCarnet" class="form-label">Ingrese el Carnet de identidad</label>
                            <input type="text" class="form-control" id="searchCarnet" placeholder="Ingrese nombre del paciente">
                        </div>
...
<script>
    $(document).ready(function() {
        $('#searchCarnet').on('input', function() {
            ...
            if(carnet.length >= 5) { // Realizar búsqueda cuando hay al menos 5 caracteres
                $.ajax({
                    url: "{{ route('buscar.paciente.dni') }}", // Ruta del endpoint de búsqueda
                    method: "GET",
                    data: { carnet: carnet },
