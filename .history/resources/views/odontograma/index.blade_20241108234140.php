      ...
      <div class="card-body">
        <div class="row">
                  ...
                  <form action="{{ route('odontograma.registrar') }}" method="POST">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="num_diente">Pieza:</label>
                        ...
                        <select class="form-select" id="num_diente" name="num_diente">
                            ...
                            <option value="11">11 (superior izquierdo)</option>
                            ...
                            <option value="21">21 (superior derecho)</option>
                            ...
                            <option value="32">32 (inferior derecho)</option>
                            ...
                            <option value="41">41 (inferior izquierdo)</option>
                      ...
                      <div class="form-group col-md-6">
                        <label for="lado_diente">Lado:</label>
          ...
          <div class="col-md-6">
            ...
            <form action="{{ route('odontograma.buscar') }}" method="GET" class="mb-3">
              <div class="form-row align-items-end">
                <div class="form-group col-md-9">
                  ...
                  <!-- Mantenemos el valor ingresado en el campo carnet -->
                  {{--  <input type="text" name="carnet" id="carnet" class="form-control" value="{{ old('carnet', request('carnet')) }}" required>  --}}
            ...
            @if(isset($paciente))
            <div class="card mt-3">
                <h5 class="card-title text-center mt-2">Información del Paciente</h5>
                <div class="card-body">
                  <div class="patient-info">
                    <p><strong>Paciente:</strong> {{ $paciente->nombre }} {{ $paciente->paterno }} {{ $paciente->materno }}</p>
                  ...
                  <tbody id="odontogramaTableBody">
                    @foreach($odontogramas as $odontograma)
                      <tr>
                        ...
                        <td>{{ $odontograma->nota }}</td>
                        <td>
                          <!-- Formulario para eliminar el registro -->
                          <form action="{{ route('odontograma.eliminar', $odontograma->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm border-0" onclick="return confirm('¿Estás seguro de que deseas eliminar este registro?')">
                                <i class="fa-regular fa-circle-minus" style="color: #ff0000;"></i>
                            </button>
                          </form>
                        </td>
                      </tr>
            ...
            @else
              <p class="mt-3">El paciente aun no tiene registro de odontograma.</p>
            @endif
          </div>
        </div>
      </div>
