            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mb-3">
                            <label for="paciente_id" class="form-label">Seleccione Paciente</label>
                            <select id="paciente_id" name="paciente_id" class="form-select">
                                <option disabled {{ is_null($selectedPacienteId) ? 'selected' : '' }}>Seleccione</option>
                                @foreach($pacientes as $paciente)
                                    <option value="{{ $paciente->id }}" {{ $paciente->id == $selectedPacienteId ? 'selected' : '' }}>
