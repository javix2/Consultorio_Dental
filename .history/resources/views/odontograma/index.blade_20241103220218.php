            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mb-3">
                            <label for="searchDNI" class="form-label">Buscar Paciente por DNI</label>
                            <input type="text" class="form-control" id="searchDNI" placeholder="Ingrese el DNI del paciente">
                        </div>
    ...
    $(document).ready(function() {
        $('#searchDNI').on('keydown', function(event) {
            if (event.key === "Enter") { // Verifica si la tecla presionada es Enter
                ...
                if(dni.length >= 5) { // Realizar búsqueda cuando hay al menos 5 caracteres
                    $.ajax({
