...
<main>
  ...
  <div class="container mt-4">
    <div class="row">
      <!-- Columna de imagen y datos de odontograma -->
      <div class="col-md-4">
        <div class="card">
          <img src="ruta_a_la_imagen" class="card-img-top" alt="Imagen del paciente">
          <div class="card-body">
            <h5 class="card-title">Información del Odontograma</h5>
            @if(isset($paciente))
            ...
            @else
              <p>Seleccione un paciente para ver los datos.</p>
            @endif
          </div>
        </div>
      </div>
  
      <!-- Columna de formulario de búsqueda y tabla -->
      <div class="col-md-8">
        ...
        @if(isset($paciente))
          <form action="{{ route('odontograma.registrar') }}" method="POST" class="mt-4">
            @csrf
            <div class="form-group">
