      ...
      <div class="modal-body">
        <form action="{{route("paciente.update", $pac->id)}}" method="POST">
          ...
          <div class="container py-3 px-7">
            ...
            {{--  <div class="form-group row">
              <label for="inputPassword" class="col-sm-3 col-form-label text-right">Ocupacion</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="inputAddress" name="txtocupacion" value="{{$item->ocupacion}}">
              </div>
            </div>  --}}
            <div class="form-group row">
