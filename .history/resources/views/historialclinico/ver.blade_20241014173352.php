  ...
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
          ...
          <div class="modal-body text-start">
            ...
            <p><strong>Motivo: </strong>{{ $pac->ci }} {{ $pac->expe}}</p>
            <div class="row">
              <div class="col-md-4">
                  <p><strong>Enfermedades Activas: </strong>{{ $histo->direccion }}</p>
              </div>
              <div class="col-md-4">
                  <p><strong>Alergias: </strong>{{ $histo->celular }}</p>
              </div>
              <div class="col-md-4">
                <p><strong>Medicamentos: </strong>{{ $histo->celular }}</p>
            </div>
            </div>
