...
<div class="container d-flex justify-content-center">
    ...
    <!-- Contenedor de la imagen fuera del card -->
  ...
  <div class="card-body mx-5 my-3">
    <form action="{{ route('perfil.update', $user->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group row">
        <label for="name" class="col-sm-3 col-form-label text-end">Usuario</label>
        <div class="col-sm-7">
      ...
      <div class="form-group row">
        <label for="current_password" class="col-sm-3 col-form-label text-end">Contraseña Actual</label>
        <div class="col-sm-7">
      ...
      <div class="form-group row">
        <label for="password" class="col-sm-3 col-form-label text-end">Contraseña Nueva</label>
        <div class="col-sm-7">
      ...
      <div class="form-group row">
        <label for="password_confirmation" class="col-sm-3 col-form-label text-end">Confirmar Contraseña</label>
        <div class="col-sm-7">
