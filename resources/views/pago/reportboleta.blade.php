...
<html lang="es">
  ...
  <body>
    ...
    <div class="modal-body px-2">
        ...
        <p class="mb-0">Nombre: {{ $pago->paciente->nombre }} {{ $pago->paciente->paterno }} {{ $pago->paciente->materno }}</p>
        <p class="mb-0">Tratamiento: {{ $pago->tratamiento->nombre }}</p>
        <p class="mb-0">Costo Tratamiento: {{ $pago->tratamiento->costo }} {{"Bs."}}</p>
        <p class="mb-0">Total Pagado: {{ $pago->monto_total }} {{"Bs."}}</p>
        <p class="mb-0">Saldo pendiente: {{ $pago->saldo }} {{"Bs."}}</p>
        <p class="mb-0">Estado:
            @if($pago->saldo==0)
