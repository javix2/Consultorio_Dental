  ...
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
          ...
          <div class="modal-body text-start">
              ...
              <p><strong>Costo Tratamiento:</strong> {{ $histo->tratamiento->costo }}  {{"Bs."}}</p>
              <p><strong>Total Pagado:</strong> {{ $histo->monto_total }} {{"Bs."}}</p>
              ...
              <p><strong>Ultima fecha de pago:</strong> {{ $histo->fecha_pago }}{{"Bs."}}</p>
